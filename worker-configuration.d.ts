/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 89f065461a6e42c71a512b44b2e8c956)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		TURNSTILE_HIGH_FREQUENCY_THRESHOLD?: string;
		TURNSTILE_SITE_KEY?: string;
		TURNSTILE_SECRET_KEY?: string;
		RATE_LIMITER: DurableObjectNamespace /* RateLimiter from bible-image-generator */;
		R2_BUCKET: R2Bucket;
		DB: D1Database;
		AI: Ai;
	}
